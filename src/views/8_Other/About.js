...
const About = (props) => {
  ...
  else if (props.location.pathname === '/privacy') return <Privacy />
  return <MainAbout />
}
...
const TermsText = () => {
  return (
    <>
      <h2 className="box-margin-bottom-20">Terms &amp; Conditions</h2>
      <p>The&nbsp;10pts&nbsp;website located at&nbsp;10pts.co&nbsp;is a copyrighted work belonging to 10pts. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>
      ...
      <h2 className="box-margin-top-20">Accounts</h2>
      <p><strong>Account Creation.</strong>&nbsp;For you to use the Site, you have to start an account and provide information about yourself. You warrant that: (a) all required registration information you submit is truthful, up-to-date and accurate; (b) you will maintain the accuracy of such information. You may delete your Account at any time by following the instructions on the Site.&nbsp; Company may suspend or terminate your Account in accordance with Section.</p>
      <p><strong>Account Responsibilities.</strong>&nbsp;You are responsible for maintaining the confidentiality of your Account login information and are fully responsible for all activities that occur under your Account. You approve to immediately notify the Company of any unauthorized use, or suspected unauthorized use of your Account.&nbsp; Company cannot and will not be liable for any loss or damage arising from your failure to comply with the above requirements.</p>
      <h2 className="box-margin-top-20">Access to the Site</h2>
      ...
      <h2 className="box-margin-top-20">Third-Party Links &amp; Ads; Other Users</h2>
      ...
      <p><strong>Cookies and Web Beacons.</strong>&nbsp;Like any other website,&nbsp;10pts&nbsp;uses &lsquo;cookies'. These cookies are used to store information including visitors' preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users' experience by customizing our web page content based on visitors' browser type and/or other information.</p>
      <p><strong>Google DoubleClick DART Cookie.</strong>&nbsp;Google is one of a third-party vendor on our site. It also uses cookies, known as DART cookies, to serve ads to our site visitors based upon their visit to www.10pts.co and other sites on the internet. However, visitors may choose to decline the use of DART cookies by visiting the Google ad and content network Privacy Policy at the following URL &ndash;&nbsp;<a href="https://policies.google.com/technologies/ads">https://policies.google.com/technologies/ads</a></p>
      ...
      <h2 className="box-margin-top-20">Disclaimers</h2>
      ...
      <h2 className="box-margin-top-20">Limitation on Liability</h2>
      ...
      <h2 className="box-margin-top-20">Copyright Policy.</h2>
      ...
      <h2 className="box-margin-top-20">General</h2>
      ...
      <p><strong>Notice Requirement and Informal Dispute Resolution.</strong>&nbsp;Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief.&nbsp; A Notice to the Company should be sent to the10pts@gmail.com. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally.&nbsp; If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding.&nbsp; The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.</p>
      ...
      <h2 className="box-margin-top-20">Contact Information</h2>
      <p>Email: the10pts@gmail.com</p>
    </>
  )
}
